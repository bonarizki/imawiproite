...
class AttritionRateTalent implements WithHeadings,WithStyles,WithEvents,ShouldAutoSize,WithColumnFormatting,FromArray,WithStrictNullComparison
{
    private $request;
    ...
    {
        return $this->ReportInterfaces->ARTalent($this->request);
    }
