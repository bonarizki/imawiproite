...
use App\Model\Awards\Menu\MenuChild;
use App\Model\Awards\Menu\MenuGrandChild;
...
class MenuController extends Controller
{
    ...
    function getModel($request)
    {
        if ($request->TypeMenu == 'menu_parent') {
            $model = 'App\Model\Awards\Menu\Menu';
        } elseif ($request->TypeMenu == 'menu_child') {
            $model = 'App\Model\Awards\Menu\MenuChild';
        } elseif ($request->TypeMenu == 'menu_grand_child') {
            $model = 'App\Model\Awards\Menu\MenuGrandChild';
        }
