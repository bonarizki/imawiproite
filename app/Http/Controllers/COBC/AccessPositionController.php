...
use App\Model\COBC\AccessPosition;
...
class AccessPositionController extends Controller
{
    public function index()
    {
        ...
        return view('cobc.access_position', compact('department', 'parent', 'child', 'grand_child'));
    }

    public function store(Request $request)
    {
        $rules = [
            'department_id' => 'required|unique:mst_cobc_access_position,department_id'
        ];
        ...
        DB::transaction(function() use ($request, $module) {
            ...
            \Helper::instance()->log('CREATE', $request, 'App\Model\COBC\AccessPosition');
    ...
    public function update(Request $request)
    {
        ...
        DB::transaction(function() use ($request, $module) {
            ...
            \Helper::instance()->log('UPDATE', $request, 'App\Model\COBC\AccessPosition');
    ...
    public function getAccessPosition(Request $request)
    {
    	$access = AccessPosition::query()
            ->selectRaw('mst_cobc_access_position.access_position_id,
                mst_cobc_access_position.department_id,
                dept.department_name,
                mst_cobc_access_position.menu')
            ->leftJoin('mst_main_department AS dept', 'dept.department_id', 'mst_cobc_access_position.department_id')
