...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->menu_type == 1) {
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('CREATE', $request, 'App\Model\COBC\MenuParent');
            });
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('CREATE', $request, 'App\Model\COBC\MenuChild');
            });
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('CREATE', $request, 'App\Model\COBC\MenuGrandChild');
            });
        }
    ...
    public function update(Request $request)
    {
        if($request->type == 1) {
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('UPDATE', $request, 'App\Model\COBC\MenuParent');
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('UPDATE', $request, 'App\Model\COBC\MenuChild');
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('UPDATE', $request, 'App\Model\COBC\MenuGrandChild');
    ...
    public function delete(Request $request)
    {
        if($request->type == 1) {
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('DELETE', $request, 'App\Model\COBC\MenuParent');
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('DELETE', $request, 'App\Model\COBC\MenuChild');
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('DELETE', $request, 'App\Model\COBC\MenuGrandChild');
    ...
    public function getMenuGrandChild(Request $request)
    {
        ...
        $grand_child = MenuGrandChild::query()
            ->selectRaw('mst_cobc_menu_grand_child.menu_grand_child_id,
                mst_cobc_menu_grand_child.menu_grand_child_name,
                mst_cobc_menu_grand_child.menu_grand_child_icon,
                mst_cobc_menu_grand_child.menu_grand_child_url,
                mst_cobc_menu_grand_child.menu_child_id,
                child.menu_parent_id')
            ->leftJoin('mst_cobc_menu_child AS child', 'child.menu_child_id', 'mst_cobc_menu_grand_child.menu_child_id')
            ->where('mst_cobc_menu_grand_child.menu_child_id', $child)
        ->get();
