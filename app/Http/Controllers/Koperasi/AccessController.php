...
{    
    ...
    {
        $query = User::with(['Grade','Title','Type','Department','KoperasiAccess'])->get();
    ...
    public function update(Request $request)
    {
        ...
        DB::transaction(function () use($request) {
            \Helper::instance()->log('UPDATE',$request,'App\Model\Koperasi\Access');
