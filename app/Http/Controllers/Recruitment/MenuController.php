...
class MenuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->menu_type == 1) {
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('CREATE', $request, 'App\Model\Recruitment\MenuParent');
            });
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('CREATE', $request, 'App\Model\Recruitment\MenuChild');
            });
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('CREATE', $request, 'App\Model\Recruitment\MenuGrandChild');
            });
        }
    ...
    public function update(Request $request)
    {
        if($request->type == 1) {
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('UPDATE', $request, 'App\Model\Recruitment\MenuParent');
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('UPDATE', $request, 'App\Model\Recruitment\MenuChild');
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('UPDATE', $request, 'App\Model\Recruitment\MenuGrandChild');
    ...
    public function delete(Request $request)
    {
        if($request->type == 1) {
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('DELETE', $request, 'App\Model\Recruitment\MenuParent');
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('DELETE', $request, 'App\Model\Recruitment\MenuChild');
            ...
            DB::transaction(function() use ($request) {
                ...
                \Helper::instance()->log('DELETE', $request, 'App\Model\Recruitment\MenuGrandChild');
    ...
    public function getMenuParent(Request $request)
    {
        ...
        return datatables()->of($parent)->addIndexColumn()
            ...
            ->addColumn('edit', function($parent) {
                return '<a href="javascript:;" class="btn-edit" data-type="1" data-id="'.$parent->menu_parent_id.'" data-name="'.$parent->menu_parent_name.'" data-icon="'.$parent->menu_parent_icon.'" data-url="'.$parent->menu_parent_url.'" data-toggle="tooltip" title="Edit"><i class="feather icon-edit"></i></a>';
            })
            ->addColumn('delete', function($parent) {
                return '<a href="javascript:;" class="btn-delete" data-type="1" data-id="'.$parent->menu_parent_id.'" data-name="'.$parent->menu_parent_name.'" data-toggle="tooltip" title="Delete"><i class="feather icon-trash"></i></a>';
            })
    ...
    public function getMenuChild(Request $request)
    {
        ...
        return datatables()->of($child)->addIndexColumn()
            ...
            ->addColumn('edit', function($child) {
                return '<a href="javascript:;" class="btn-edit" data-type="2" data-id="'.$child->menu_child_id.'" data-name="'.$child->menu_child_name.'" data-icon="'.$child->menu_child_icon.'" data-url="'.$child->menu_child_url.'" data-parent="'.$child->menu_parent_id.'" data-toggle="tooltip" title="Edit"><i class="feather icon-edit"></i></a>';
            })
            ->addColumn('delete', function($child) {
                return '<a href="javascript:;" class="btn-delete" data-type="2" data-id="'.$child->menu_child_id.'" data-name="'.$child->menu_child_name.'" data-toggle="tooltip" title="Delete"><i class="feather icon-trash"></i></a>';
            })
            ->rawColumns(['detail', 'icon', 'edit', 'delete'])
        ->toJson();
    }
    ...
    public function getMenuGrandChild(Request $request)
    {
        ...
        $grand_child = MenuGrandChild::query()
            ->selectRaw('mst_recruitment_menu_grand_child.menu_grand_child_id,
                mst_recruitment_menu_grand_child.menu_grand_child_name,
                mst_recruitment_menu_grand_child.menu_grand_child_icon,
                mst_recruitment_menu_grand_child.menu_grand_child_url,
                mst_recruitment_menu_grand_child.menu_child_id,
                child.menu_parent_id')
            ->leftJoin('mst_recruitment_menu_child AS child', 'child.menu_child_id', 'mst_recruitment_menu_grand_child.menu_child_id')
            ->where('mst_recruitment_menu_grand_child.menu_child_id', $child)
        ->get();
        ...
        return datatables()->of($grand_child)->addIndexColumn()
            ...
            ->addColumn('edit', function($grand_child) {
                return '<a href="javascript:;" class="btn-edit" data-type="3" data-id="'.$grand_child->menu_grand_child_id.'" data-name="'.$grand_child->menu_grand_child_name.'" data-icon="'.$grand_child->menu_grand_child_icon.'" data-url="'.$grand_child->menu_grand_child_url.'" data-parent="'.$grand_child->menu_parent_id.'" data-child="'.$grand_child->menu_child_id.'" data-toggle="tooltip" title="Edit"><i class="feather icon-edit"></i></a>';
            })
            ->addColumn('delete', function($grand_child) {
                return '<a href="javascript:;" class="btn-delete" data-type="3" data-id="'.$grand_child->menu_grand_child_id.'" data-name="'.$grand_child->menu_grand_child_name.'" data-toggle="tooltip" title="Delete"><i class="feather icon-trash"></i></a>';
            })
