...
<body style="padding-left: 2.5rem; padding-right: 2.5rem;">
    ...
    <table class="table table-bordered">
        <td><?php echo str_replace("\n", "<br>", $appraisal->milestone_feedback); ?></td>
    </table>
    ...
    <p class="font-weight-bold" style="font-size: 18px;"> SECTION II : COMPETENCY </p>
    <p class="font-weight-bold" style="font-size: 13px;">Guide to Competencies Review :</p>
    <table style="width: 100%;">
        <tbody>
            <tr>
                <td style="width: 3%; font-size: 13px;"><b>I.</b></td>
                <td style="font-size: 13px;">Self Assessment of competency is filled with reference to the 4 levels of proficiency in the options provided.</td>
            </tr>
            <tr>
                <td style="width: 3%; font-size: 13px;"><b>II.</b></td>
                <td style="font-size: 13px;">Proficiency levels are arranged by category Basic (first choice) and Expert (last choice).</td>
            </tr>
            <tr>
                <td style="width: 3%; font-size: 13px;"><b>III.</b></td>
                <td style="font-size: 13px;">Assessment is done by looking at the suitability of your abilities/skills in completing the work.</td>
            </tr>
            <tr>
                <td style="width: 3%; font-size: 13px;"><b>IV.</b></td>
                <td style="font-size: 13px;">In the competency section provided by norm description and order through proficiency level (from top to down).</td>
            </tr>
        </tbody>
    </table>
    <table class="table table-bordered mt-2">
        <thead>
            <tr>
                ...
                <th style="width: 30%;"> Proficiency Level Assessment<br>from Employee </th>
                <th> Proficiency Level Assessment<br>from Superior </th>
            </tr>
        </thead>
        <tbody>
        	@foreach($competency as $key => $com)
        		<tr>
        			...
        			<td><?php echo "<b>".$com['competency_title']."</b><br>".str_replace("\n", "<br>", htmlentities($com['competency_eng'])); ?></td>
                    <td><?php echo str_replace("\n", "<br>", htmlentities($com['proficiency_'.$com['employee_rating'].'_eng'])); ?></td>
                    <td><?php echo str_replace("\n", "<br>", htmlentities($com['proficiency_'.$com['superior_rating'].'_eng'])); ?></td>
        		</tr>
        	@endforeach
        </tbody>
    </table>
    ...
    <h6 class="font-weight-bold">Feedback from Superior and Superior's Superior</h6>
    <table class="table table-bordered">
