...
<!-- Begin Modal Add -->
<!-- ============================================================== -->
<div class="modal modal-blur fade" tabindex="-1" role="dialog" aria-hidden="true" id="addMenu">
            ...
            <form method="post">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-3 form-label col-form-label required">Type Menu</label>
                        <div class="col-9">
...
<!-- Begin Modal edit -->
<!-- ============================================================== -->
<div class="modal modal-blur fade" tabindex="-1" role="dialog" aria-hidden="true" id="editMenu">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form method="post">
                {{ csrf_field() }}
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-3 col-form-label form-label">Type Menu</label>
                        <div class="col-9">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        $('.nav-master_menu').addClass('active');
        ...
        $(document).on('click', '.btn-detail-child', function(e) {
            ...
            if(row.child.isShown()) {
                ...
                var table_child = $(`#table_child_${id}`).DataTable({
                    ...
                    lengthChange : false,
                    ajax : {
                        url : "{{ url('api/appraisal/menu/child') }}",
                        data : function(d) {
                            d.parent_id = id;
                        }
                    },
            ...
            $(`#table_child_${row.data().menu_parent_id}`).on('click', '.btn-detail-grand-child', function(e) {
                ...
                if(row.child.isShown()) {
                    ...
                    var table_grand_child = $(`#table_grand_child_${id}`).DataTable({
                        ...
                        lengthChange : false,
                        ajax : {
                            url : "{{ url('api/appraisal/menu/grand-child') }}",
                            data : function(d) {
                                d.child_id = id;
                            }
                        },
        ...
        $(document).on('submit', '#editMenu form', function(e) {
            ...
            $.ajax({
                url : "{{ url('api/appraisal/menu/update') }}",
                type : "POST",
        ...
        $(document).on('change', '#addMenu select[name=menu_type]', function(e) {
            ...
            if($(this).val() == 1) {
                var html = `<div class="form-group row">
                                <label class="col-3 form-label col-form-label required">Menu Name</label>
                                <div class="col-9">
                            ...
                            <div class="form-group row">
                                <label class="col-3 form-label col-form-label required">Menu Icon</label>
                                <div class="col-9">
                                    <input type="text" name="menu_parent_icon" class="form-control" id="menu_parent_icon_add" maxlength="20" placeholder="Type menu icon..">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-3 form-label col-form-label required">Menu URL</label>
                                <div class="col-9">
                ...
                var html = `<div class="form-group row">
                                <label class="col-3 form-label col-form-label required">Menu Parent</label>
                                <div class="col-9">
                            ...
                            <div class="form-group row">
                                <label class="col-3 form-label col-form-label required">Menu Icon</label>
                                <div class="col-9">
                                    <input type="text" name="menu_child_icon" class="form-control" id="menu_child_icon_add" maxlength="20" placeholder="Type menu icon..">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            <div class="form-group row">
                ...
                var html = `<div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label class="col-3 form-label col-form-label required">Menu Child</label>
                                <div class="col-9">
                            ...
                            <div class="form-group row">
                                <label class="col-3 form-label col-form-label required">Menu Icon</label>
                                <div class="col-9">
                                    <input type="text" name="menu_grand_child_icon" class="form-control" id="menu_grand_child_icon_add" maxlength="20" placeholder="Type menu icon..">
                                    <span class="invalid-feedback"></span>
                                </div>
                            </div>
                            <div class="form-group row">
        ...
        $(document).on('change', '#addMenu select[name=menu_parent_id]', function(e) {
            ...
            if(type == 3) {
                ...
                $.ajax({
                    type : "GET",
                    url : "{{ url('api/appraisal/menu/child') }}?parent_id="+$(this).val(),
                    dataType : "JSON",
                    success : function(res) {
                        if(res.data) {
        ...
        $(document).on('click', '.btn-delete', function(e) {
            swal({
                ...
                if(result.value) {
                    $.ajax({
                        url : "{{ url('api/appraisal/menu/delete') }}",
                        type : "POST",
                        data : {
                            "_token" : "{{ csrf_token() }}",
                            id : this.dataset.id,
