...
<div class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="viewAppraisalConfidentialStaff">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered table-striped table-objective">
                    <thead>
                        <tr>
                            ...
                            <th data-eng="Employee's Assessment Regarding<br>Achievement of Objective / Work Area" data-bhs="Penilaian Karyawan Mengenai<br>Pencapaian Objective / KPI">Penilaian Karyawan Mengenai<br>Pencapaian Objective / Area Kerja</th>
                            <th data-eng="Superior's Assessment Regarding<br>Achievement of Objective / Work Area" data-bhs="Penilaian Atasan Mengenai<br>Pencapaian Objective / KPI">Penilaian Atasan Mengenai<br>Pencapaian Objective / Area Kerja</th>
                ...
                <div class="confidential_summary"></div>
...
$(document).on('click', '.btn-view_confidential_staff', function(e) {
    var modal = $('#viewAppraisalConfidentialStaff');
    ...
    $.ajax({
        ...
        success : function(res) {
            ...
            var final_score = '';
            if(res.appraisal.final_score != null) {
                final_score = ''+
                    '<table class="table table-bordered">'+
                        '<td class="font-weight-bold" style="width: 85%;"><span data-eng="FINAL SCORE" data-bhs="NILAI AKHIR">NILAI AKHIR </span><small data-eng="(recommended by superior)" data-bhs="(rekomendasi atasan)">(rekomendasi atasan)</small></td>'+
                        '<td class="font-weight-bold" style="text-align: center;">'+res.appraisal.final_score+'</td>'+
                    '</table>';
            }

            modal.find('.final_score').html(final_score);

            var confidential_summary = '';
            if(res.appraisal.confidential_summary != null) {
                confidential_summary = ''+
                    '<h4 class="font-weight-bold mb-0 mt-3" data-eng="Confidential Summary & Management Development Plan" data-bhs="Kesimpulan Confidential & Rencana Pengembangan Manajemen">Kesimpulan Confidential & Rencana Pengembangan Manajemen</h4>'+
                    '<small data-eng="Overall view of job holder’s performance and short to medium term aspiration<br>To be completed by assessor and reviewed with his superior" data-bhs="Pandangan keseluruhan tentang kinerja karyawan dan aspirasi jangka pendek hingga menengah<br>Dilengkapi oleh penilai dan ditinjau bersama atasannya">Pandangan keseluruhan tentang kinerja karyawan dan aspirasi jangka pendek hingga menengah<br>Dilengkapi oleh penilai dan ditinjau bersama atasannya</small>'+
                    '<table class="table table-bordered mt-2">'+
                        '<td>'+res.appraisal.confidential_summary.replace(/\n/g, '<br>')+'</td>'+
                    '</table>';
            }

            modal.find('.confidential_summary').html(confidential_summary);
