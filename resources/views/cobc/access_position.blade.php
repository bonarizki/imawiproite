...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 align-self-center">
            <h4 class="page-title d-inline">Access Position</h4>
            <div class="d-flex align-items-center float-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1 mg-b-0">
                        <li class="breadcrumb-item">Master</li>
                        <li class="breadcrumb-item active" aria-current="page">Access Position</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        $('.nav-management_access_position').addClass('active');
		...
		var table = $('#table-access').DataTable({
            ...
            scrollX : true,
            ajax : {
                url : "{{ url('api/cobc/access-position') }}",
                data : function(d) {
		...
		$(document).on('submit', '#editAccess form', function(e) {
            ...
            $.ajax({
				url : "{{ url('api/cobc/access-position/update') }}",
                type : "POST",
                ...
                success : function(res) {
                    ...
                    toastr.success('Access Position have been updated!', 'Success', { "closeButton": true });
                },
                error : function(jqXhr, textStatus, errorThrown) {
