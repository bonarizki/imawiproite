...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-12 align-self-center">
            <h4 class="page-title d-inline">Menu</h4>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        $('.nav-management_menu').addClass('active');
            ...
            $(`#table_child_${row.data().menu_parent_id}`).on('click', '.btn-detail-grand-child', function(e) {
                ...
                if(row.child.isShown()) {
                    ...
                    var table_grand_child = $(`#table_grand_child_${id}`).DataTable({
                        ...
                        lengthChange : false,
                        ajax : {
                            url : "{{ url('api/cobc/menu/grand-child') }}",
                            data : function(d) {
                                d.child_id = id;
                            }
                        },
        ...
        $(document).on('change', '#addMenu select[name=menu_parent_id]', function(e) {
            ...
            if(type == 3) {
                ...
                $.ajax({
                    type : "GET",
                    url : "{{ url('api/cobc/menu/child') }}?parent_id="+$(this).val(),
                    dataType : "JSON",
                    success : function(res) {
                        if(res.data) {
