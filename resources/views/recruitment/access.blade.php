...
<div class="content-header-left col-md-9 col-12 mb-2">
    <div class="row breadcrumbs-top">
        <div class="col-12">
            <h2 class="content-header-title float-left mb-0">Master Access</h2>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        setTimeout(function() {
            ...
            $('.nav-master_access').addClass('sidebar-group-active').addClass('active').addClass('open');
        }, 2000);
		...
		var table = $('#table-access').DataTable({
            ...
            scrollX : true,
            ajax : {
                url : "{{ url('api/recruitment/access') }}",
                data : function(d) {
		...
		$(document).on('submit', '#editAccess form', function(e) {
            ...
            $.ajax({
				url : "{{ url('api/recruitment/access/update') }}",
                type : "POST",
