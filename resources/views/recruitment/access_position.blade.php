...
<div class="content-header-left col-md-9 col-12 mb-2">
    <div class="row breadcrumbs-top">
        <div class="col-12">
            <h2 class="content-header-title float-left mb-0">Master Access Position</h2>
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Master</a>
                    </li>
                    <li class="breadcrumb-item active">Access Position
                    </li>
                </ol>
            </div>
        </div>
			...
			<div class="card">
                <div class="card-header">
                    <a href="#addAccess" class="btn btn-primary" data-toggle="modal">
                        <i class="feather icon-plus"></i> Add Access Position
                    </a>
                </div>
                <div class="card-body">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        setTimeout(function() {
            ...
            $('.nav-master_access_position').addClass('sidebar-group-active').addClass('active').addClass('open');
        }, 2000);
		...
		var table = $('#table-access').DataTable({
            ...
            scrollX : true,
            ajax : {
                url : "{{ url('api/recruitment/access-position') }}",
                data : function(d) {
		...
		$(document).on('submit', '#editAccess form', function(e) {
            ...
            $.ajax({
				url : "{{ url('api/recruitment/access-position/update') }}",
                type : "POST",
