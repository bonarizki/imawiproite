...
<body style="padding-left: 2.5rem; padding-right: 2.5rem;">
    ...
    <div class="row">
        <p class="col-md-3">Processed Date</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">{{ date_format(date_create($recruit->lead_time_start), "D, j M Y") }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Closing Date</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">{{ date_format(date_create($recruit->lead_time_end), "D, j M Y") }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Lead Time</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">{{ $recruit->lead_time }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Candidate Name</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">{{ $recruit->candidate_name }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Hiring Resource</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">{{ $recruit->hiring_resource }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Join Date</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">{{ date_format(date_create($recruit->join_date), "D, j M Y") }}</p>
    </div><br>
    <h4>Hiring Cost</h4>
    <div class="row">
        <p class="col-md-3">External Cost</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">Rp. {{ number_format($recruit->external_cost, 0, '.', ',') }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Internal Cost</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">Rp. {{ number_format($recruit->internal_cost, 0, '.', ',') }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Advertising Expenses</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">Rp. {{ number_format($recruit->advertising_expenses, 0, '.', ',') }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Assessment Online</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">Rp. {{ number_format($recruit->assessment_online, 0, '.', ',') }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Medical Checkup</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">Rp. {{ number_format($recruit->medical_checkup, 0, '.', ',') }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Travel Expenses</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">Rp. {{ number_format($recruit->travel_expenses, 0, '.', ',') }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Hiring Bonus</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">Rp. {{ number_format($recruit->hiring_bonus, 0, '.', ',') }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Referral Bonus</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">Rp. {{ number_format($recruit->referral_bonus, 0, '.', ',') }}</p>
    </div>
    <div class="row">
        <p class="col-md-3">Grand Total</p>
        <p class="col-md-1">:</p>
        <p class="col-md-8">Rp. {{ number_format($recruit->external_cost + $recruit->internal_cost + $recruit->advertising_expenses + $recruit->assessment_online + $recruit->medical_checkup + $recruit->travel_expenses + $recruit->hiring_bonus + $recruit->referral_bonus, 0, '.', ',') }}</p>
    </div>
    <hr>
