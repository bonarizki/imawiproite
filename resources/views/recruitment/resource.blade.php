...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">Hiring Resource</h2>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Recruitment</li>
                        <li class="breadcrumb-item">Report</li>
                        <li class="breadcrumb-item active">Hiring Resource</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <table class="table table-bordered table-striped nowrap" id="table-level" style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2"> Grade Group </th>
                                        <th rowspan="2" style="text-align: center;"> Total<br>Fulfilled<br>Request </th>
                                        <th rowspan="1" colspan="6" style="text-align: center;"> Hiring Resource </th>
                                    </tr>
                                    <tr>
                                        <th style="text-align: center;"> Head Hunter </th>
                                        <th style="text-align: center;"> Job Fair </th>
                                        <th style="text-align: center;"> Job Ads </th>
                                        <th style="text-align: center;"> LinkedIn </th>
                                        <th style="text-align: center;"> Outsourcing </th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        setTimeout(function() {
            ...
            $('.nav-hiring_resource').addClass('sidebar-group-active').addClass('active').addClass('open');
        }, 3000);
        ...
        var table_level = $('#table-level').DataTable({
            ...
            scrollX : true,
            ajax : {
                url : "{{ url('api/recruitment/resource-by-level') }}",
                data : function(d) {
            ...
            columns : [
                ...
                { data : 'head_hunter', name : 'head_hunter' },
                { data : 'job_fair', name : 'job_fair' },
                { data : 'job_ads', name : 'job_ads' },
                { data : 'linkedin', name : 'linkedin' },
                { data : 'outsourcing', name : 'outsourcing' },
        ...
        var table_dept = $('#table-dept').DataTable({
            ...
            scrollX : true,
            ajax : {
                url : "{{ url('api/recruitment/resource-by-dept') }}",
                data : function(d) {
        ...
        $(document).on('click', '.btn-export', function(e) {
            ...
            $('.btn-export').attr('href', '{!! url("/recruitment/resource/export?period='+period+'&department='+department+'&gg='+grade_group+'") !!}');
        });
