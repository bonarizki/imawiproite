    ...
    <script>
        $(document).ready(function () {
            $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{url('/resgination/all/access/user')}}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
                    ...
                    {
                        data: 'resignation_access.access_id',
                        name : 'resignation_access.access_id',
                        render: function (data, type, row, meta) {
        ...
        function Access(access_id,type){
            ...
            $.ajax({
                type:"get",
                url:"{{url('/resignation/detail/access')}}/"+access_id,
        ...
        function update(access_id){
            ...
            $.ajax({
                type:'PUT',
                url:"{{url('/resignation/access/update')}}",
                data:data,
                success:function(response){
