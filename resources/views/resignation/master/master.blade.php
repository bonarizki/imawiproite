...
<head>
    <title>I'am A Wiproite | Resignation - @yield('title')</title>
...
<body class="horizontal-layout horizontal-menu 2-columns  navbar-floating footer-static " data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
                        ...
                        <li class="dropdown dropdown-user nav-item">
                            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div class="user-nav d-sm-flex d-none">
                                    ...
                                    <span class="user-status">{{ Auth::user()->Title->title_name}}</span>
                                </div>
        ...
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-without-dd-arrow navbar-shadow menu-border" role="navigation" data-menu="menu-wrapper">
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                ...
                <ul class="nav navbar-nav hover" id="main-menu-navigation" data-menu="menu-navigation">
                    @php
                        $allMenu = App\Model\Resignation\Menu\Menu::with(['MenuChild','MenuChild.MenuGrandChild'])->get();
                        $access = App\Model\Resignation\Access::where('user_id', Auth::user()->user_id)->first();
                        if ($access) {
    ...
    <script>
        $(document).ready(function () {
            ...
            $.ajax({
                type: "get",
                url: "{{url('breadcumResignation')}}",
                data: {
                    path: path
                },
                success: function (response) {
                    let data = response.data;
                    let breadcumb = '<li class="breadcrumb-item"><a href="{{url('/resignation')}}">Home</a></li>'
                    if (path != 'resignation') {
                        if (data != null) {
