...
@section('breadcumb','Attrition Based on Years')
@section('title','Attrition Based on Years')
                    ...
                    <table class="table table-bordered table-striped nowrap" id="table-total" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th rowspan="1" colspan="4" style="text-align: center;"> Years </th>
                            </tr>
                            <tr>
                                <th style="text-align: center;"> Less than 1 year </th>
                                <th style="text-align: center;"> 1 to 3 years </th>
                                <th style="text-align: center;"> 3 to 10 years </th>
                                <th style="text-align: center;"> More than 10 years </th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var table_total = $('#table-total').DataTable({
            ...
            sDom : 't',
            ajax : {
                url : "{{ url('api/resignation/report/years') }}",
                data : function(d) {
            ...
            columnDefs : [
                ...
                { createdCell : function(td, data, rowData, row, col) {
                    $(td).css('text-align', 'center') }, targets : [0,2,3,4,5]
                }
            ],
            order : []
        });
        ...
        $(document).on('click', '.btn-export', function(e) {
            ...
            window.open('{!! url("resignation/report/years/export?dept='+department+'&type='+type+'&month='+month+'&quarter='+quarter+'&year='+year+'&period='+period+'") !!}');
        });
