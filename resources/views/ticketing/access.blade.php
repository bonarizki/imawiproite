...
@section('breadcumb','Management Access')
    ...
    <script>
        $(document).ready(function () {
            $('#table').DataTable({
                ...
                ajax: "{{url('ticketing/all/access/user')}}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
                    ...
                    {
                        data: 'ticketing_access.access_id',
                        name : 'ticketing_access.access_id',
                        render: function (data, type, row, meta) {
                            return `<center>
        ...
        Access = (access_id,type) => {
            ...
            $.ajax({
                type:"get",
                url:"{{url('ticketing/detail/access')}}/"+access_id,
        ...
        update = (access_id) => {
            ...
            $.ajax({
                type:'PUT',
                url:"{{url('ticketing/access/update')}}",
                data:data,
                success:function(response){
