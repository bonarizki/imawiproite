...
@section('breadcumb','Management Access Position')
    ...
    <script>
        $(document).ready(function () {
            $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{url('ticketing/all/access-position/data')}}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
        ...
        Access = (access_id,type) => {
            ...
            $.ajax({
                type:"get",
                url:"{{url('ticketing/all/access-position')}}/"+access_id,
        ...
        update = (access_id) => {
            ...
            $.ajax({
                type:'PUT',
                url:"{{url('ticketing/all/access-position')}}",
                data:data,
                success:function(response){
