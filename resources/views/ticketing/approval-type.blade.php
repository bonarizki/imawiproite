...
@section('title','Management Approval Type')
@section('breadcumb','Management Approval Type')
                    ...
                    <form class="form form-vertical" id="form">
                        ...
                        <div class="form-body">
                            <div class="row form-body-row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="approval_nik">Approval</label>
                                        <select name="approval_nik" id="approval_nik" class="form-control">
                                            <option value="">Select Agent</option>
                                        </select>
                                        <small id="approval_nik_alert" class="form-text text-danger"></small>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function () {
            $('#table').DataTable({
                ...
                ajax: "{{url('ticketing/all/approval/type')}}",
                columns:[
                    {
                        data: "DT_RowIndex",
                        name: "DT_RowIndex"
        ...
        const field = ["type_name","approval_nik"];

        modal = (type,id = null) => {
            type == "add" 
            ? $(`#approval_nik`).val("").select2({dropdownParent: $('#modal')})
            : "";
