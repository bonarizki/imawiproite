...
@section('breadcumb','Management Menu')
...
@section('footer')
    ...
    <script>
            ...
            var table = $('#table').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function (data, row, type, meta) {
                            return `<center>
                                        <badge class="btn btn-sm btn-info" onclick="modalShow('edit','menu_parent','${data}')"><i class="fas fa-user-edit"></i> Edit</badge>
                                    </center>`
                        }
                    },
                    {
            ...
            $('#table tbody').on('click', 'td.details-control', function () {
                ...
                if (row.child.isShown()) {
                    ...
                    var table_child = $(`#table_child_${id}`).DataTable({
                        ...
                        sDom: 'lrtip',
                        destroy: true,
                        ajax: "{{url('ticketing/all/menuChild')}}/" + id,
                        columns: [{
                ...
                $(`#table_child_${row.data().menu_parent_id} tbody`).on('click', 'td.details-control-child', function () {
                    ...
                    if (row.child.isShown()) {
                        ...
                        $(`#table_grand_child_${id}`).DataTable({
                            ...
                            destroy: true,
                            sDom: 'lrtip',
                            ajax: "{{url('ticketing/all/menuGrandChild')}}/" + id,
                                        columns: [{
                                    data: 'DT_RowIndex',
                                    name: 'DT_RowIndex'
                                },
        ...
        optionChild = (d) => {
            ...
            if (id != '') {
                $.ajax({
                    url: "{{url('ticketing/all/menuChild')}}/" + id,
                    type: "GET",
                    success: function (response) {
                        let data = response.data;
                        let option = '';
