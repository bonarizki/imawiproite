    ...
    <script>
        $(document).ready(function () {
            $('#table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{url('training/all/access/user')}}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
                    ...
                    {
                        data: 'training_access.access_id',
                        name : 'training_access.access_id',
                        render: function (data, type, row, meta) {
        ...
        function Access(access_id,type){
            ...
            $.ajax({
                type:"get",
                url:"{{url('training/detail/access')}}/"+access_id,
        ...
        function update(access_id){
            ...
            $.ajax({
                type:'PUT',
                url:"{{url('training/access/update')}}",
                data:data,
                success:function(response){
