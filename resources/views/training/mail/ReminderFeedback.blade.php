                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" class="mcnTextContent"
                                                                            ...
                                                                            <span style="font-size:14px">Thank you for participating in the training on the topic of <b> {{$data->Training->training_topic}} </b>,
                                                                                 but now we need your response to fix any deficiencies in the training that will be held in the future
                                                                            </span><br>
                                                                            <span>
                                                                                Go to <a href="https://imawiproite.wipro-unza.co.id">I'm A Wiproite</a> to give your feedback
                                                                            </span>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
