...
<script src="{{asset('assets_vuexy/app-assets/vendors/js/charts/apexcharts.min.js')}}"></script>
...
<script src="{{asset('assets_vuexy/app-assets/vendors/js/tables/datatable/pdfmake.min.js')}}"></script>
<script src="{{asset('assets_vuexy/app-assets/vendors/js/tables/datatable/vfs_fonts.js')}}"></script>
...
<!-- BEGIN: Page JS-->
<script src="{{asset('assets_vuexy/app-assets/js/scripts/pages/dashboard-analytics.js')}}"></script>
<script src="{{asset('assets_vuexy/app-assets/js/scripts/datatables/datatable.js')}}"></script>
...
{{-- <script src="{{asset('assets_vuexy/app-assets/js/scripts/pickers/dateTime/pick-a-datetime.js')}}"></script> --}}

{{-- Validation By Bona --}}
<script src="{{asset('js/valbon.js')}}"></script>
