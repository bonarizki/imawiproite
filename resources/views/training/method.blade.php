            ...
            <div class="card shadow-lg">
                <div class="card-content">
                    <div class="card-body card-dashboard table-responsive">
                        <div>
                            <button class="btn btn-success" onclick="modal('add')"><i class="fa fa-plus"></i> Add Method</button>
                        </div>
                        ...
                        <div class="row form-body-row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="method_name" class="form-control option" name="method_name" placeholder="Method Name">
                                    <small id="method_name_alert" class="form-text text-danger"></small>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#table').DataTable({
                serverSide: true,
                destroy: true,
                ajax: "{{url('training/all/method/data')}}",
                columns: [{
                        data: "DT_RowIndex",
                        name: "DT_RowIndex"
                    },
