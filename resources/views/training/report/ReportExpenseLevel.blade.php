...
@section('title','Report Training Expense Level')
...
<script>
    ...
    function viewData(type)
    {
        ...
        $.ajax({
            type:"post",
            data: data,
            url:"{{url('training/report/expense-level/view')}}",
    ...
    function download(type) {
        ...
        data += `&type=${type}`;
        console.log(data)
        window.open("{{url('training/report/expense-level/download')}}?"+data , '_blank');
    }
